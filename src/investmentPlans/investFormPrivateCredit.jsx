      ...
      .then(async () => {
        ...
        try {
          const response = await fetch(
            API_CONFIG.FORMS.SUBMIT_PRODUCT_FORM('private-credit'),
            {
              method: "POST",
              headers: {
          ...
          if (response.ok) {
            ...
            alert(
              data.message ||
                "Failed to submit private credit investment request.",
            );
          }
        } catch (err) {
      ...
      {open && typeof document !== "undefined" && createPortal(
        ...
        >
          <div
            ...
            role="dialog"
            aria-modal="true"
            aria-label="Apply for Invest in Private Credit"
          >
            <button
              onClick={handleClose}
              aria-label="Close"
            ...
            >
              Apply for Invest in Private Credit
            </h2>
              ...
              >
                ...
                <div style={row2}>
                  ...
                  <Field
                    as="select"
                    name="fundType"
                    placeholder="Invest in Private Credit"
                  ...
                  >
                    ...
                    <option>Invest in Mutual Funds</option>
                    <option>Invest in Company</option>
                    <option>Invest in Private Credit</option>
                    <option>Invest in Firm</option>
                  </Field>
                </div>
                <div style={row2}>
                  <Field
                    name="tenure"
                    placeholder="Tenure minimum 12 months and max 36 months"
