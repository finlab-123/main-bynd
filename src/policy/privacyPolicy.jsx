      ...
      <div className="policy-container">
        ...
        <main className="policy-content">
          ...
          <ul>
            ...
            <li>For the purpose of sending administrative notices and Service-related alerts and similar communication, as detailed under this Privacy Policy, with a view to optimizing the efficiency of the BYND FINSERVE App / Website.</li>
          ...
          <h2>Consulting</h2>
          <p>
            BYND FINSERVE may partner with another party to provide certain specific services if required. When you sign-up for such services, BYND FINSERVE will share names, or other Personal Information that is necessary for the third party to provide these Services. BYND FINSERVE’s contractual arrangements with such third parties restrict these parties from using personally identifiable information except for the explicit purpose of assisting in the provision of these Services.
          </p>

          <h2>Third-Party Policies</h2>
          <p>
            We may engage with various third parties in connection with the Credit Services availed through the BYND FINSERVE App / Website. In general, the third-party service providers we work with will only collect, use, and disclose your information to the extent necessary to perform the services or activities they provide to us. When sharing information with these service providers, we take appropriate security measures and make commercially reasonable efforts to ensure that all recipients adhere to confidentiality, fidelity, and secrecy obligations as well as sign covenants to that effect. We require such third parties to provide the same or equivalent level of protection to your information as outlined in this Privacy Policy. It is important to note that once you provide information to or interact with third parties through the BYND FINSERVE App / Website, our Privacy Policy will no longer apply, and we cannot be held responsible for the privacy practices of these third parties.
          </p>
          <p>
            However, certain third-party service providers, such as banks, financial institutions, payment aggregators, or credit information companies, may have their own privacy policies governing the information we are required to share with them. We recommend reviewing their privacy policies to understand how they handle your information. It’s important to be aware that certain third-party service providers may be located in or have facilities located in different jurisdictions. Therefore, if you proceed with a transaction involving the services of such a third-party provider, your information may become subject to the laws of the jurisdiction(s) in which the provider is located or where its facilities are located. Once you leave the BYND FINSERVE App / Website and are redirected to a third-party website or application, you will no longer be governed by our Privacy Policy or the BYND FINSERVE’s terms and conditions. Instead, the privacy policy of the respective website or application will apply. We cannot be held liable for the actions or omissions of these third-party service providers.
          </p>

          <h2>Disclosure of Information</h2>
          <p>
            We cooperate with government and law enforcement officials and private parties to enforce and comply with the law. Thus, we may access, use, store, transfer and disclose your information (including Personal Information), including disclosure to third parties such as government or law enforcement officials or private parties as we reasonably determine is necessary and appropriate: (i) to satisfy any applicable law, regulation, governmental requests or legal process. (ii) to protect the safety, rights, property or security of BYND FINSERVE, our Services, the BYND FINSERVE Website or any third party; (iii) to protect the safety of the public for any reason; (iv) to detect, prevent or otherwise address fraud, security or technical issues; and /or (v) to prevent or stop any activity we consider to be, or to pose a risk of being, an illegal, unethical, or legally actionable activity. Such disclosures may be carried out without notice to you.
          </p>
          ...
          <p>
            The consent that you provide for the collection, use and disclosure of your Personal Information will remain valid until such time it is withdrawn by you in writing. If you withdraw your consent, BYND FINSERVE will stop processing the relevant Personal Information except to the extent that we have other grounds for processing such Personal Information under applicable laws. BYND FINSERVE will respond to your request within a reasonable timeframe. You may withdraw your consent at any time by contacting us or by using the functionalities of the BYND FINSERVE Website. We will not retain your information if it is no longer necessary for our purposes and there are no legal requirements mandating its retention. However, please be aware that there may be multiple legal bases that require us to retain certain information at any given time.
          </p>
          <p>
          ...
          <p>
            Upon registration, you may receive certain communication from us, and you may at any time choose to opt-out of receiving further communications from us. To be completely removed from the BYND FINSERVE’s mailing list, you may contact us at contact@BYNDFINSERVE.com If you are using an e-mail forwarding service or other similar service, please make sure to include the correct e-mail address or addresses.
          </p>

          <h2>Grievance Officer</h2>
          <p>
            In accordance with the Information Technology Act, 2000 and the rules made thereunder, the name and contact details of the Grievance Officer are provided below. Any User grievance relating to the discrepancies or misuse of information so provided to BYND FINSERVE may be addressed to the grievance officer, whose details are provided below appointed by BYND FINSERVE for this purpose.
          </p>
          <ul>
