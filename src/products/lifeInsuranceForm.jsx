...
const schema = yup.object({
  ...
  fundType: yup.string().trim().required('Select a life insurance type'),
      ...
      .then(async () => {
        ...
        try {
          const response = await fetch(
            API_CONFIG.FORMS.SUBMIT_PRODUCT_FORM('life-insurance'),
            {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json'
              },
              body: JSON.stringify({ ...formData, productCategory: 'Life Insurance' })
            }
          )
          if (response.ok) {
            ...
            alert(data.message || 'Failed to submit life insurance request.')
          }
        } catch (err) {
      ...
      {open && typeof document !== 'undefined' && createPortal(
        ...
        >
          <div
            ...
            role='dialog'
            aria-modal='true'
            aria-label='Apply For Life Insurance'
          >
            <button
              onClick={handleClose}
              aria-label='Close'
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                ...
                <div style={row2}>
                  ...
                  <Field
                    as='select'
                    name='fundType'
                    placeholder='Type of Life Insurance'
              ...
              >
                Your details stay secure with encrypted submission. A licensed
                advisor will contact you with plan options.
              </p>
