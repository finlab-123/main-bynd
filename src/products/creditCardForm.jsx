      ...
      .then(async () => {
        ...
        try {
          const response = await fetch(
            API_CONFIG.FORMS.SUBMIT_PRODUCT_FORM('credit-card'),
            {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json'
              },
              body: JSON.stringify({ ...formData, productCategory: 'Credit Card' })
            }
          )
          if (response.ok) {
            ...
            alert(data.message || 'Failed to submit credit card request.')
          }
        } catch (err) {
      ...
      {open && typeof document !== 'undefined' && createPortal(
        ...
        >
          <div
            ...
            role='dialog'
            aria-modal='true'
            aria-label='Apply for Credit Card form'
          >
            <button
              onClick={handleClose}
              aria-label='Close'
              ...
              >
                ...
                <div style={row2}>
                  ...
                  <Field
                    as='select'
                    name='fundType'
                    placeholder='Invest in Mutual Funds'
                  ...
                  >
                    ...
                    <option>Invest in Credit Card</option>
                  </Field>
                </div>
                <div style={row2}>
                  <Field
